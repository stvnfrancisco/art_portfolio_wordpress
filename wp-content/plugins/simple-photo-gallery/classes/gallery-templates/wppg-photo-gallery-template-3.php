...
?>
        <link type="text/css" rel="stylesheet" href="<?php echo WP_PHOTO_URL.'/classes/gallery-templates/css/wppg-photo-gallery-template-3.css?ver='.WP_PHOTO_VERSION; ?>" />
